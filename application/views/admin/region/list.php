    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h1 class="box-title">Region List</h1>
                <a href="<?php echo base_url(); ?>admin/region/add" class="btn btn-primary pull-right">
            ...
            <input type="hidden" name="_token" value="Sk3doWItxaoAFLb19cHZYUeNW7yMPNDp1QqkSi60">                <div class="box-body">
                     <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url();?>admin/region/edit/<?php echo $list->id;?>" class="btn btn-warning">Edit</a></td>
                            <td>
                            <form action="" method="post">
                                <input type="hidden" name="_token" value="Sk3doWItxaoAFLb19cHZYUeNW7yMPNDp1QqkSi60">
                                <input type="hidden" name="_method" value="DELETE">
                                <a href="<?php echo base_url() . "admin/region/region_delete/" . $list->id; ?>" class="btn btn-danger" type="submit">Delete</a>
