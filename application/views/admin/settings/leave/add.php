            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h1 class="box-title"> Insert Employee Leave Tpye</h1>
                    </div>
                    <form action="<?php echo base_url(); ?>admin/settings/insert_leave_type" id="employment-form" method="post"
