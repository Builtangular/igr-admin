            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h1 class="box-title"> Update Employee Tpye</h1>
                    </div>
                    <form action="<?php echo base_url(); ?>admin/settings/update" id="employment-form"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="type" name="type"
                                            value="<?php echo $type_details->type;?>" class="form-control"
                        ...
                        <div class="box-footer">
                            <input type="hidden" name="id" class="form-control" id="id"
                                value="<?php if(!empty($type_details)){echo $type_details->id;}?>">
