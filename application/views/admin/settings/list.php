            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <a href="<?php echo base_url(); ?>admin/settings/add" class="btn btn-primary pull-right">
                    ...
                    <div class="box-body">
                        <table id="rddata" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php foreach($type_details as $data){ $i++;
                                    
                                ?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><?php echo $data->type; ?></td>
                                    <td><a href="<?php echo base_url();?>admin/settings/edit/<?php echo $data->id;?>"
