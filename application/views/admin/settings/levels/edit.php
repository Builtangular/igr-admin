            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h1 class="box-title"> Update Employee Level</h1>
                    </div>
                    <form action="<?php echo base_url(); ?>admin/settings/update_levels" id="employment-form"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="type" name="type"
                                            value="<?php echo $levels_data->type;?>" class="form-control"
                        ...
                        <div class="box-footer">
                            <input type="hidden" name="id" class="form-control" id="id"
                                value="<?php if(!empty($levels_data)){echo $levels_data->id;}?>">
