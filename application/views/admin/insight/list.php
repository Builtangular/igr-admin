            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="<?php echo base_url(); ?>admin/market-insight/add/<?php echo $report_id; ?>"
                        ...
                        <table class="table table-striped">
                            ...
                            <?php $i=1; foreach($market_insight as $data) { 
                                ...
                                <tr style="font-size: 14px;">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>admin/market-insight/edit/<?php echo $data['id']; ?>"
                                            class="btn btn-warning">Edit</a>
                                    </td>
                                    <form action="<?php echo base_url(); ?>admin/market-insight/delete/<?php echo $data['id']; ?>" method="post"
