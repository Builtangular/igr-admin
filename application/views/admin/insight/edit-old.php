        ...
        <div class='row'>
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>admin/market-insight/update/<?php echo $report_id; ?>" method="post" class="form-horizontal">
                        <div class="box-body">
                            <div class="col-md-12">
                                <?php foreach($market_insight as $insight) { 
                                    $type_name = explode(" ", $insight['type']);
                                    $area_name = str_replace(' ','_', $insight['type']);
                                    // var_dump($type_name); die;
                                    ?>
                                <div class="form-group">
                                    <label class="control-label col-md-2"><?php echo $insight['type']; ?></label>
                                    <div class="col-md-9">
                                        <textarea type="text" name="<?php echo $area_name.$insight['id']; ?>[]" rows="5"
                                            class="form-control"><?php echo $insight['description']; ?></textarea>
                                    </div>
                                    <div class="col-md-1">
                                        <center><span type="button" class="btn btn-block btn-info"
                                                id="<?php echo strtolower($type_name[1]); ?>_addrow"><i class="fa fa-plus"></i> Add</span></center>
                                    </div>                                    
                                </div>
                                <span  id="<?php echo $type_name[1]; ?>"></span>
                                <input type="hidden" name="<?php echo $type_name[1]; ?>" id="<?php echo $type_name[1]; ?>" value="<?php echo $insight['type']; ?>" class="form-control">
                                <?php } ?>
                               <!--  Report Description 
                                <div class="form-group">
