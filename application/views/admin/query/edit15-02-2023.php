                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control b-none" name="source" id="source">
                                        <option value="<?php echo $single_query_data->source;?>" selected><?php echo $single_query_data->source;?></option>
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="source_mail_id" name="source_mail_id" value="<?php echo $single_query_data->source_mail_id;?>" class="form-control"
                                ...
                                <div class="col-md-3">
                                    <select class="form-control b-none" id="reseller_name" name="reseller_name">
                                        <option value="<?php echo $single_query_data->reseller_name;?>" selected><?php echo $single_query_data->reseller_name;?></option>
                                        <?php 						
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control b-none" id="scope_name" name="scope_name">
                                            <option value="<?php echo $single_query_data->scope_name;?>" selected><?php echo $single_query_data->scope_name;?></option>
                                            <?php 						
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="client_name" name="client_name" value="<?php echo $single_query_data->client_name;?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="phone_no" name="phone_no" value="<?php echo $single_query_data->phone_no;?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="company_name" name="company_name" value="<?php echo $single_query_data->company_name;?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="designation" name="designation" value="<?php echo $single_query_data->designation;?>" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="report_name" name="report_name" value="<?php echo $single_query_data->report_name;?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="client_email" name="client_email" value="<?php echo $single_query_data->client_email;?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="client_message" id="client_message" rows="3"
                                            class="form-control" placeholder="Client Meassage" required><?php echo $single_query_data->client_message;?></textarea>
                                        <span class="help-block margin" id="txtHint"></span>
                                    </div>
                                </div>
                                <div class="form-group">
