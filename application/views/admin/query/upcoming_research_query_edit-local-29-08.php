                                    ...
                                    <form
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="commentfor" id="commentfor" value="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="hidden" name="view_comment" class="form-control"
                                                        id="view_comment" value="view_comment">
    ...
    $('.edit_comment').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById("query_id").value = jso.query_id;
                document.getElementById("attachment").value = jso.attachment;
                document.getElementById("username1").value = jso.user_name;
                document.getElementById("commentfor").value = jso.comment_for;
            }
        });
    });
});
