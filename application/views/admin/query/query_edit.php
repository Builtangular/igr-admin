        ...
        <div class='row'>
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>admin/query/query_update" id="employment-form" method="post"
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <?php } else { ?>
                                <label class="control-label col-md-1 hide" id="reseller_div">Reseller <span
