        ...
        <div class='row'>
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>admin/spam_mail/export_data" method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
                        <div class="box-body">
                            <div class="col-md-9">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-1">
                                        <input type="submit" value="Export Excel" class="btn btn-info pull-left" value="Submit">
                                    </div>
                                </div>
                            </div>
                        </div>
