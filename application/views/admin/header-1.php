        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="<?php echo base_url(); ?>admin/report"><i
                                class="fa fa-file-pdf-o"></i><span class="text-bold">Published Reports</span></a></li>
                    <li><a href="<?php echo base_url(); ?>admin/country-rd"><i
                                class="fa fa-file-word-o"></i><span class="text-bold">Country Reports</span></a></li>
                    <li><a href="<?php echo base_url(); ?>admin/report/verified_rd"><i
                                class="fa fa-file"></i><span class="text-bold">Verified RDs</span></a></li>
                    ...
                    <li><a href="<?php echo base_url(); ?>sales/custom-link"><i class="fa fa-file-word-o"></i><span
                        ...
                        <li><a href="<?php echo base_url(); ?>admin/employee"><i
                                class="fa fa-file-excel-o"></i><span class="text-bold">Employee Data</span></a></li>                       
                    <?php } ?>
                    <?php if($Role_id == 7){?>
                        <li><a href="<?php echo base_url(); ?>admin/spam-mail"><i
                                class="fa fa-file-excel-o"></i><span class="text-bold">Spam Mail</span></a></li>
