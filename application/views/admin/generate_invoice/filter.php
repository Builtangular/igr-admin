        ...
        <div class='row'>
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url('admin/generate_invoice/filter_list');?>" method="post"
                        class="form-horizontal">
                        <input type="hidden" name="_token" value="Sk3doWItxaoAFLb19cHZYUeNW7yMPNDp1QqkSi60">
                        <div class="box-body">
                            <!-- <div class="form-group">
                                <label class="control-label col-md-2">Invoice Type</label>
                                <div class="col-md-4">
                                    <select class="form-control b-none" id="invoice_type" name="invoice_type">
