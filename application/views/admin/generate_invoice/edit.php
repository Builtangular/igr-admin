...
<?php $Payment = array('Paypal', 'CC Avenue', 'Bank Transfer');?>
        ...
        <div class='row'>
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>admin/generate_invoice/update" method="post"
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="invoice_title" id="invoice_title" class="form-control"
                                        value="<?php echo $invoice_data->invoice_title;?>" placeholder="Invoice Title"
                                        required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if($invoice_type == "Main") {?>
                                <label class="control-label col-md-2">Inward No.<span class="text-red">*</span></label>
                                <div class="col-md-3">
                                    <input type="text" id="inward_no" name="inward_no"
                                        value="<?php echo $invoice_data->inward_no;?>" class="form-control"
                                        placeholder="Inword No">
                                </div>
                                <?php }?>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2">Order No.<span class="text-red">*</span></label>
                                <div class="col-md-3">
                                ...
                                <?php if($invoice_type == "Main") {?>
                                <label class="control-label col-md-2">Payment Mode<span
                                        class="text-red">*</span></label>
                                <div class="col-md-3">
                                    <select class="form-control b-none" id="payment_mode" name="payment_mode"
                                        placeholder="">
                                        <option value="" selected>Select Payment Mode</option>
                                        <?php $i = 0; foreach($Payment as $payment) {
                                            if ($Payment[$i] == $invoice_data->payment_mode){ ?>
                                        <option value="<?php echo $invoice_data->payment_mode; ?>" Selected>
                                            <?php echo $invoice_data->payment_mode; ?></option>
                                        <?php }else{ ?>
                                        <option value="<?php echo $Payment[$i]; ?>"><?php echo $Payment[$i]; ?>
                                        </option>
                                        <?php } $i++; }  ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if($invoice_type == "Main") {?>
                                <label class="control-label col-md-2">Inward Date<span class="text-red">*</span></label>
                                <div class="col-md-3">
                                    <input type="date" id="inward_date" name="inward_date"
                                        value="<?php echo $invoice_data->inward_date;?>" class="form-control"
                                        placeholder="Inword Date">
                                </div>
                                <?php } ?>
                            </div>
                            ...
                            <div class="form-group" id="my_div1">
                                ...
                                <div class="col-md-3">
                                    <input type="radio" name="state" value="Maharastra"
                                            <?php echo ($invoice_data->state =='Maharastra')?'checked':'' ?> /> Maharastra &nbsp;&nbsp;
                                    <input type="radio" name="state" value="Other State"
                                            <?php echo ($invoice_data->state =='Other State')?'checked':'' ?> /> Other State
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" id="dis_percentage" name="percentage" onblur="reSum();"
                                            value="<?php echo $invoice_data->percent_discount;?>" class="form-control"
                                            placeholder="Percentage">
                                    </div>
                                    <div class="col-md-3">
                                        <b>Discount (Absolute)<span class="text-red">*</span></b>
                                        <input type="text" id="absolute_price" name="absolute_price" onblur="reSum();"
                                            value="<?php echo $invoice_data->absolute_discount;?>" class="form-control"
