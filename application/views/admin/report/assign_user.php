        ...
        <div class='row'>
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>admin/report/update_assigned_user/<?php echo $single_rd_data->id;?>" method="post" class="form-horizontal"
                        autocomplete="off">
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <label class="control-label"><?php  echo $scope_name." ".$single_rd_data->title; ?> </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
