            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h1 class="box-title"> Employment Details</h1>
                    </div>
                    <form action="<?php echo base_url(); ?>admin/employee/insert_employment/<?php echo $emp_id; ?>"
                    id="employment-form" method="post" class="form-horizontal" autocomplete="off" enctype="multipart/form-data">
                    <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="company_address" id="company_address" rows="3"
                                            class="form-control" placeholder="Company Address" required></textarea>
                                        <span class="help-block margin" id="txtHint"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Last Drown Salary </label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Ref. Contact No. </label>
                                    <div class="col-md-8">
                    ...
                    <div class="box-footer">
                        <input type="submit" class="btn btn-info pull-right" style='margin-right:16px' name="button" value="Submit">
                        <!-- <input type="submit" class="btn btn-info pull-right" style='margin-right:16px'  formnovalidate name="button" value="Skip"> -->
                    </div>
                    </form>
                </div>
            </div>
