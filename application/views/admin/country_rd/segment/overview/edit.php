        ...
        <div class='row'>
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>admin/country_segment/overview_update/<?php echo $report_id; ?>"
                        method="post" class="form-horizontal">
                        <div class="box-body">
                            <div class="col-md-12">
                                <?php foreach($get_rd_segment as $data){ 
                                    $segment_overview = "SELECT id, description FROM tbl_country_rd_segment_overview where segment_id = ".$data->id;
