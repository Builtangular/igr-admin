                    ...
                    <form action="<?php echo base_url(); ?>admin/segment_overview/update/<?php echo $report_id; ?>"
                        ...
                        <div class="col-md-12">
                                ...
                                foreach($get_rd_segment as $data){ 
                                    ...
                                    $segment_overview = "SELECT description AS description FROM tbl_rd_segment_overview where segment_id = ".$data->id;
                                    ...
                                    if ($query_segment_overview->num_rows() > 0) {
                                        ...
                                        // var_dump($rd_segment_overview); die;
                                    }
                                    ?>
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="seg_id[]" id="seg_id" value="<?php echo $data->id;?>"
                                        class="form-control">
                                 <input type="hidden" name="report_id" id="report_id" value="<?php echo $data->id;?>"
                                        class="form-control">
                                </div>
                                <?php } ?>
                            </div>
