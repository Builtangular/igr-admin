		...
		if($this->session->userdata('logged_in')){
			...
			for($i = 1; $i <= 9; $i++) {
				...
				else if($i==8)
				{
					...
					$table_cell->addText("The market sizing is based on the historic data for ".$From_historic." to ".$analysis_from.", the report however presents ".$Base_year." as a base year, and then forecast provided is for ".$forecast_from." to ".$forecast_to,'trStyle1', 'Table Bullet');
