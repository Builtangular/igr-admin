...
class Generate_rd extends CI_Controller {    
	...
	public function sample_pages(){
		...
		if($this->session->userdata('logged_in')){
			...
			$section->addTextBreak(1);
			$section->addText(htmlspecialchars('Primary Sources considered during this particular study:'), array('align'=>'left', 'bold'=>true, 'name'=>'Franklin Gothic Medium', 'color'=>'#000', 'size' => 10.5));
			$section->addImage('images/primary_sources.png', array('width'=>680, 'height'=>280, 'align'=>'center'));
			$section->addText('Source: Infinium Global Research Analysis', 'Source Note', 'sourceStyle');
			$section->addTextBreak(1);
			...
			$section->addTextBreak(1);
			$section->addText(htmlspecialchars('The secondary sources of the data typically include'), array('align'=>'left', 'bold'=>false, 'name'=>'Franklin Gothic Medium', 'color'=>'#000', 'size' => 10.5));
			...
			$section->addText(htmlspecialchars('This data point includes information on most lucrative country markets in 2022'), array('align'=>'left', 'bold'=>true, 'name'=>'Franklin Gothic Medium', 'color'=>'#000', 'size' => 10.5));
			/* $textbox = $section->addTextBox(array('align' => 'center', 'width' => 700, 'height' => 'auto', 'borderSize'  => 1, 'borderColor' => '#000',));
			$textbox->addText(htmlspecialchars('Content removed from the sample'), array('bold'=>false, 'align'=>'center','name'=>'Franklin Gothic Medium','color'=> 'red','size'=>10), 'thStyle'); */
			...
			/* Segment Overview */
				...
				if($segment_overview){
					...
					$section->addText(htmlspecialchars($Report_name_scope.' segmented based on '.$segments5->name.' as '), 'r2Style', 'paragraphStyle');
