...
class Generate_rd extends CI_Controller {    
	...
	public function sample_pages(){
		...
		if($this->session->userdata('logged_in')){
			...
			$table->addCell(1300, array('borderBottomSize' => 15, 'borderBottomColor' => '#E59C24', 'marginLeft'  => 0.5, 'marginRight' => 0.5, 'marginTop'   => 0.5,  'marginBottom'=> 0.5, array('space' => array('before' => 160, 'after' => 80))))->addImage('images/logo.png', array('width'=>110, 'height'=>32, 'positioning' => 'relative'));
